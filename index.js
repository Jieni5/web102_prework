...
let displayStr =
  `A total of ${totalRaised.toLocaleString()} has been raised for ${totalGames} games. Currently, ${unfundedGamesCount > 0 ? unfundedGamesCount : no} games are still in need of funding.`;
